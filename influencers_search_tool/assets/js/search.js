...
jQuery(document).ready(function ($) { 
    ...
    search_form.on('submit', (e) => {
            ...
            .then((res_data) => {
                ...
                if(res_data.count > 0){
                    for (let index = 0; index < 6; index++) {
                        const influencer = res_data.data[index];
                        const influencer_card = `
                        <div class="IG-tool-profile-card ${card_colors[index%4]}">
                            <div class="IG-tool-profile-head">
                                ...
                                <h6>${influencer.username} <small>Digital Creator, ${influencer.location_unified}</small> </h6>
                            </div>
                            ...
                            <div class="IG-tool-profile-foot">
                                <ul>
                                ${influencer.hashtags.map(hashtag => "<li>#" + hashtag + "</li>")}
                                </ul>
                            </div>
                        </div>
                        `;
                        ...
                        $('#blur_result_section').html(`
                            ...
                            <div class="IG-tool-notify">
                                <div class="inner-content">
                                    <h3>To see all ${res_data.count} results, start a free trial</h3>
        ...
        console.log('entered search params:', form_values);
    })
