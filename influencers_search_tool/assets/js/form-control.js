...
const populateSelectOptions = (select_id, options_list, placeholder_text="", same_value_as_name=false) => {
...
const addToInputList = () => {
    const keywords_input_field = $('#bio_keywords_input')
...
const range_min_dropdown = $('#min_followers_qty');
const range_max_dropdown = $('#max_followers_qty');
...
range_min_dropdown.on('change', () => {
    ...
    const new_range_for_max = followers_range.filter(val => val.value > selected_min);
    
    range_max_dropdown.empty();
    populateSelectOptions(range_max_dropdown, new_range_for_max, placeholder_text='Max');
